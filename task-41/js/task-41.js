...
DatePicker.prototype = {
	...
	init: function  () {
		...
		var str = curDate.getFullYear()+"年"+curDate.getMonth()+"月";

		var input = $("<input>").attr('readyonly', 'true').css({
			textAlign: 'center',
			width: '210px',
			height: '30px'
		}).attr('value', str).appendTo(container);

		var calendarEle = this.mainEle = $("<div>").
						css({
							width: '350px',
							height: '400px',
